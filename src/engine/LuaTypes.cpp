...
void luaAddEnums(sol::state_view& lua) {
    ...
    lua["GameObjectClassType"] = lua.create_table_with(
        ...
        "Smart", 5, 5, "Smart");
    log::debug("added GameObjectClassType");
    lua["Speed"] = lua.create_table_with(
        ...
        "Faster", 3, 3, "Faster",
        "Fastest", 4, 4, "Fastest");
    log::debug("added Speed");
}

#define WriteHook(T, N, B) struct N { static void f(T* object, sol::this_state lua) B }

auto pointZero = new CCPoint {0, 0};
void luaAddUsertypes(sol::state_view& lua, EditorUI* self) {
    auto pointType = lua.new_usertype<LuaPoint>("point", sol::constructors<LuaPoint(double, double)>(),
        ...
        sol::meta_function::subtraction, &LuaPoint::operator-,
    ...
    log::debug("added GameObject properties 2");
    ...
    { //trigger parameters
        /*//trigger common
        gameObjectType["duration"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_duration);
        gameObjectType["easingRate"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_easingRate);
        gameObjectType["isSpawnTriggered"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_isSpawnTriggered);
        gameObjectType["isTouchTriggered"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_isTouchTriggered);
        gameObjectType["isMultiTriggered"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_isMultiTriggered);
        gameObjectType["easingType"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_easingType);
        gameObjectType["ignoreLinkedObjects"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_ignoreLinkedObjects);
        gameObjectType["ignoreGroupParent"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_ignoreGroupParent);
        gameObjectType["opacity"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_opacity);
        //color trigger
        gameObjectType["triggerTargetColor"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_triggerTargetColor);
        gameObjectType["usesBlending"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_usesBlending);
        gameObjectType["targetColorID"] = &GameObject::m_targetColor; //this one is on GameObject for some reason, no idea why
        gameObjectType["copyColorID"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_copyColorID);
        gameObjectType["legacyHSV"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_legacyHSV);
        gameObjectType["copyOpacity"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_copyOpacity);
        gameObjectType["hsvValue"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_hsvValue);
        //background color trigger
        gameObjectType["tintGround"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_tintGround);
        //move trigger, camera offset trigger, camera guide trigger
        gameObjectType["moveOffset"] = gameObjectSubclassPointProperty(lua, &EffectGameObject::m_moveOffset);
        //move trigger
        gameObjectType["moveModX"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_moveModX);
        gameObjectType["moveModY"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_moveModY);
        //rotate trigger, camera rotate trigger
        gameObjectType["rotationDegrees"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_rotationDegrees);
        gameObjectType["rotationOffset"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_rotationOffset);
        //pulse trigger
        gameObjectType["fadeInDuration"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_fadeInDuration);
        gameObjectType["holdDuration"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_holdDuration);
        gameObjectType["fadeOutDuration"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_fadeOutDuration);
        //shake trigger
        gameObjectType["shakeStrength"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_shakeStrength);
        gameObjectType["shakeInterval"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_shakeInterval);
        //follow trigger
        gameObjectType["followXMod"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_followXMod);
        gameObjectType["followYMod"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_followYMod);
        //follow player Y trigger
        gameObjectType["followYSpeed"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_followYSpeed);
        gameObjectType["followYDelay"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_followYDelay);
        gameObjectType["followYMaxSpeed"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_followYMaxSpeed);
        //camera zoom trigger, camera guide trigger
        gameObjectType["zoomValue"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_zoomValue);
        //camera mode trigger
        gameObjectType["cameraPaddingValue"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_cameraPaddingValue);
        //timewarp trigger
        gameObjectType["timeWarpTimeMod"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_timeWarpTimeMod);
        //gravity trigger
        gameObjectType["gravityValue"] = gameObjectSubclassProperty(lua, &EffectGameObject::m_gravityValue);

        //scale trigger
        gameObjectType["objectScaleX"] = gameObjectSubclassProperty(lua, &TransformTriggerGameObject::m_objectScaleX);*/
        ...
        WriteHook(EffectGameObject, durationHook, {
            ...
            if (!object->m_dontIgnoreDuration)
                object->m_endPosition = *pointZero;
        });
        ...
        gameObjectType["isReverse"] = gameObjectSubclassProperty<&EffectGameObject::m_isReverse>();
        gameObjectType["controlID"] = gameObjectSubclassProperty<&EffectGameObject::m_controlID>();
        log::debug("added GameObject properties 7");
        ...
        log::debug("added GameObject properties 8");
        ...
        //why so many properties for advanced follow trigger aaaa
        {
            ...
            log::debug("added GameObject properties 9");
        }
        ...
        log::debug("added GameObject properties 10");
        ...
        log::debug("added GameObject properties 11");
        ...
        log::debug("added GameObject properties 12");
        ...
        log::debug("added GameObject properties 13");
    }
}