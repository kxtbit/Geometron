...
- `EasingType, ZLayer, GameObjectClassType, Speed` - Enumerations with a finite number of states; see [enums.md](enums.md)
...
- The `io.*` library has been reimplemented, and many functions do not work properly; see [io.md](io.md) for details